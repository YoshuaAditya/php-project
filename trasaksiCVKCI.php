                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form id="form_send" action='processing/prosesTransaksiKCI.php?prs=4&trx=<?php echo $transaksi;?>&proses=<?php echo $proses; ?>' method ='post'  enctype="multipart/form-data">
                                ...
                                <label for="exampleInputEmail1">Jenis Transaksi</label>
                                    ...
                                    <input type='text' class="form-control" placeholder='Proyek Tol ABC' name='qty' ><br> 
