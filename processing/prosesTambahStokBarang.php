<?php
    ...
    if(!$fk_id_lokasi || !$fk_id_perusahaan || !$nama_barang || !$stock){

       header("location:../stokBarang.php?alert=1");

    }else {
        $query = "INSERT INTO stock_barang(fk_id_lokasi, fk_id_perusahaan, nama_barang, stock, status_barang) VALUES
        ('".$fk_id_lokasi."','".$fk_id_perusahaan."','".$nama_barang."','".$stock."','".$status_barang."')";
